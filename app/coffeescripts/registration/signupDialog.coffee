...
import teacherDialog from 'jst/registration/teacherDialog'
import studentDialog from 'jst/registration/studentDialog'
import parentDialog from 'jst/registration/parentDialog'
import newParentDialog from 'jst/registration/newParentDialog'
